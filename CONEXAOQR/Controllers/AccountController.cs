...
namespace CONEXAOQR.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        private ModelContainer dbSeguridad = new ModelContainer();
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    ...
                    string lblIPAddress = Convert.ToString(ipEntry.AddressList[ipEntry.AddressList.Length - 1]);
        ...
        public ActionResult LogOff()
        {
            ...
            Historial historial = new Historial();
            historial.Usuario = User.Identity.GetUserName();
            historial.TipoAccion = "Cerrar sesión";
            historial.FechaHora = DateTime.Now;
            historial.Accion = "Dirección IP: " +
                               lblIPAddress + " | " +
                               "Nombre de la computadora: " + strHostName;
